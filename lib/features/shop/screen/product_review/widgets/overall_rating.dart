import "package:e_mart/features/shop/screen/product_review/widgets/rating_progress_indicator.dart";
...
class TOverallRating extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        Expanded(flex: 3, child: Text("4.6", style: Theme.of(context).textTheme.displayLarge,)),
        const Expanded(
          flex: 7,
          child: Column(
            children: [
